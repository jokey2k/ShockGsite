...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.xfire'
        db.add_column('djangobb_forum_profile', 'xfire', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)

        # Adding field 'Profile.birthday'
        db.add_column('djangobb_forum_profile', 'birthday', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.xfire'
        db.delete_column('djangobb_forum_profile', 'xfire')

        # Deleting field 'Profile.birthday'
        db.delete_column('djangobb_forum_profile', 'birthday')
    ...
    models = {
        ...
        'djangobb_forum.profile': {
            ...
            'xfire': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
